...
if gpus:
  ...
  try:
    tf.config.set_logical_device_configuration(
        gpus[0],
        [tf.config.LogicalDeviceConfiguration(memory_limit=1024*3.8)])
...
import pickle
with open('/media/chidesiv/DATA2/Gauged_simplified/1_layer/Multi_station/Static_variables/Standalone/'+'study_'+str(modtype)+str(GWL_type)+'.pkl','rb') as f:
