...
import pickle
with open('/media/chidesiv/DATA2/Gauged_simplified/1_layer/Multi_station/Static_variables/Wavelet/'+'study_'+str(modtype)+str(wavelet)+str(GWL_type)+'.pkl','rb') as f:
