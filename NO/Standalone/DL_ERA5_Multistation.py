...
with open('/media/chidesiv/DATA2/Gauged_simplified/1_layer/Multi_station/No_OHE_NO_static/Standalone/'+'study_'+str(modtype)+str(GWL_type)+'.pkl','rb') as f:
...
for code in final_df['code_bss'].unique():
    ...
    pyplot.title((str(modtype)+' '+ "ERA5 NO ohe no static"+str(code)), size=24,fontweight = 'bold')
